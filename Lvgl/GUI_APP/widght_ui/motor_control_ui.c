...
static void Motor_Data_Indicate_Lab(lv_obj_t *_parent)
{
    ...
    lv_obj_set_pos(motors_data[0],250,40);
...
static void Three_Indicate_Lab(lv_obj_t *_parent)
{
    ...
    lv_obj_set_pos(circular_label[0],340,40);
